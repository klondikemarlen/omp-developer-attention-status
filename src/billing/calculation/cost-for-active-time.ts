...
export function effectivePaidHourlyCost(config: DeveloperCostConfig): Big {
  const annualHours = Big(config.workingHoursPerWeek).times(config.workingWeeksPerYear)
